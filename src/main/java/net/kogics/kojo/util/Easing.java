...
public interface Easing {
    ...
    public static final Easing SINE_IN = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return -c * (float) java.lang.Math.cos(t / d * (java.lang.Math.PI / 2)) + c + b;
        }
    };
    ...
    public static final Easing SINE_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return c * (float) java.lang.Math.sin(t / d * (java.lang.Math.PI / 2)) + b;
        }
    };
    ...
    public static final Easing SINE_IN_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return -c / 2 * ((float) java.lang.Math.cos(java.lang.Math.PI * t / d) - 1) + b;
        }
    };
    ...
    public static final Easing EXPO_IN = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return (t == 0) ? b : c * (float) java.lang.Math.pow(2, 10 * (t / d - 1)) + b;
        }
    };
    ...
    public static final Easing EXPO_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return (t == d) ? b + c : c * (-(float) java.lang.Math.pow(2, -10 * t / d) + 1) + b;
        }
    };
    ...
    public static final Easing EXPO_IN_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            if (t == 0) return b;
            if (t == d) return b + c;
            if ((t /= d / 2) < 1) return c / 2 * (float) java.lang.Math.pow(2, 10 * (t - 1)) + b;
            return c / 2 * (-(float) java.lang.Math.pow(2, -10 * --t) + 2) + b;
        }
    };
    ...
    public static final Easing CIRC_IN = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return -c * ((float) java.lang.Math.sqrt(1 - (t /= d) * t) - 1) + b;
        }
    };
    ...
    public static final Easing CIRC_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return c * (float) java.lang.Math.sqrt(1 - (t = t / d - 1) * t) + b;
        }
    };
    ...
    public static final Easing CIRC_IN_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            if ((t /= d / 2) < 1) return -c / 2 * ((float) java.lang.Math.sqrt(1 - t * t) - 1) + b;
            return c / 2 * ((float) java.lang.Math.sqrt(1 - (t -= 2) * t) + 1) + b;
        }
    };
    ...
    public static class ElasticIn extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (a < java.lang.Math.abs(c)) {
                a = c;
                s = p / 4;
            } else s = p / (float) (2 * java.lang.Math.PI) * (float) java.lang.Math.asin(c / a);
            return -(a * (float) java.lang.Math.pow(2, 10 * (t -= 1)) * (float) java.lang.Math.sin((t * d - s) * (2 * java.lang.Math.PI) / p)) + b;
        }
    }
    ...
    public static class ElasticOut extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            return a * (float) java.lang.Math.pow(2, -10 * t) * (float) java.lang.Math.sin((t * d - s) * (2 * java.lang.Math.PI) / p) + c + b;
        }
    }
    ...
    public static class ElasticInOut extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (t < 1)
                return -.5f * (a * (float) java.lang.Math.pow(2, 10 * (t -= 1)) * (float) java.lang.Math.sin((t * d - s) * (2 * java.lang.Math.PI) / p)) + b;
            return a * (float) java.lang.Math.pow(2, -10 * (t -= 1)) * (float) java.lang.Math.sin((t * d - s) * (2 * java.lang.Math.PI) / p) * .5f + c + b;
        }
    }
