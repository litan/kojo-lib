...
/** The Swedish and English api can be accessed via this one-line import: import net.kogics.kojo.Swedish.*, padda.*,
  * CanvasAPI.*, TurtleAPI.*
  */
object Swedish {
  ...
  class Padda(override val englishTurtle: Turtle) extends SwedishTurtle {
    def this(startX: Double, startY: Double, kostymFilNamn: String) =
      this(CanvasAPI.newTurtle(startX, startY, kostymFilNamn))
